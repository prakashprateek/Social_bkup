...
public class SocialAppRequestStatus
{
	...
	public SocialAppRequestStatus( int errorCode, String errorMessage, Object payload)
	{
		super();
	...
	{
		return "RequestStatus [errorCode=" + statusCode + ", errorMessage=" + statusMessage + "]";
	}
